...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { body: @thought.body, client_id: @thought.client_id, product_id: @thought.product_id }
    end
  ...
  test "should update thought" do
    patch :update, id: @thought, thought: { body: @thought.body, client_id: @thought.client_id, product_id: @thought.product_id }
    assert_redirected_to thought_path(assigns(:thought))
  end
