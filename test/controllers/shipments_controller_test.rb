...
class ShipmentsControllerTest < ActionController::TestCase
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post :create, shipment: { is_complete: @shipment.is_complete, method: @shipment.method, price: @shipment.price }
    end
  ...
  test "should update shipment" do
    patch :update, id: @shipment, shipment: { is_complete: @shipment.is_complete, method: @shipment.method, price: @shipment.price }
    assert_redirected_to shipment_path(assigns(:shipment))
  end
