...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { client_id: @rate.client_id, product_id: @rate.product_id, rate: @rate.rate }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { client_id: @rate.client_id, product_id: @rate.product_id, rate: @rate.rate }
    assert_redirected_to rate_path(assigns(:rate))
  end
